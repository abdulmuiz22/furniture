...
export default function TopBar() {
  const tickerItems = (
    <div className="flex items-center shrink-0">
      ...
      <span className="text-[#b37e44]/60 mx-6 font-bold text-xs select-none">&bull;</span>
      ...
      <a
        ...
        className="flex items-center gap-1.5 font-semibold text-[#1c1917] hover:text-[#b37e44] transition-colors"
      >
      ...
      <a
        ...
        className="flex items-center gap-1.5 text-[#3f3f46] hover:text-[#b37e44] transition-colors"
      >
  ...
  return (
    <div className="w-full bg-[#f8f5f0] border-b border-[#eae4da] text-[#52525b] text-[11px] sm:text-xs py-2 overflow-hidden select-none">
